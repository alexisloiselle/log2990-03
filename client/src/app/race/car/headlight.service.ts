...
export class HeadlightService {
    ...
    public constructor(direction: THREE.Vector3) {
        this.createHeadlight(direction);
        this.isLightOpen = false;
    }

    private createHeadlight(direction: THREE.Vector3): void {
        ...
        this.headlight.position.copy(direction);
    }
